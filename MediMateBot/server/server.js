...
app.post("/chat", async (req, res) => {
  ...
  try {
    ...
    // Convert prior turns into a simple text transcript so Gemini has memory
...
// Generate a structured consultation report as a downloadable PDF
